...
Required Python libraries to run app:
django,
...
SECRET_KEY = 'django-insecure-x1o^*z&4o8pg7)v_cnv5046zduse7mj_ep$+x2%=m@$s0o486j'
...
INSTALLED_APPS = [
    ...
    'rest_framework', #ip install djangorestframework
